...
- `git clone https://github.com/UniversalPropositions/UP_Italian-ParTUT.git`
...
- `python3 up2/merge_ud_up.py --input_ud=<ud_path_to_UD_Italian-ParTUT>/ --input_up=<up_path_to_UP_Italian-ParTUT>/ --output=<path_to_UD+UP_Italian-ParTUT>/`
